...
function AjoutProduitDialog({ open, handleClose,handleFileChange, handleChangeAjout, handleSubmit,formValueAjout }) {
  ...
  return (
        ...
        >
          <DialogTitle><h3 style={{textAlign:'center'}}>Ajouter un Produit</h3></DialogTitle>
          <DialogContent>
...
/>
          ...
          disabled={
            formValueAjout.description===undefined ||
            formValueAjout.qt===undefined||
            formValueAjout.prix===undefined ||
            formValueAjout.promo ===undefined ||
            formValueAjout.categorie===undefined||
            formValueAjout.design===undefined||
            formValueAjout.description=== '' ||
            formValueAjout.qt=== ''||
            formValueAjout.prix=== '' ||
            formValueAjout.promo === '' ||
            formValueAjout.categorie=== '' ||
            formValueAjout.design=== ''                 
           }
...
export default AjoutProduitDialog;
